...
//			throw Exceptions.unchecked(e);
			throw  new GeneratorCodePluginException("renderString异常"+e.toString());
		}
	}
	...
	public static String renderTemplate(Template template, Object model) {
		try {
			...
			throw  new GeneratorCodePluginException("renderTemplate异常"+e.toString());
		}
	}
